...
double CalculateDiscount()
{
    ...
    return dis[i] = (t > 0 && t <= 10) ? t * 0.1 : (t > 10 && t <= 20) ? t * 0.2
                                               : (t > 20 && t <= 30)   ? t * 0.3
                                               : (t > 30 && t <= 40)   ? t * 0.4
                                               : (t > 40 && t <= 60)   ? t * 0.5
                                               : (t > 60 && t <= 70)   ? t * 0.6
...
void Display()
{
    cout << setw(12) << code[i] << setw(12) << name[i] << setw(12) << price[i] << setw(12) << qty[i] << setw(12) << CalculateTotal() << setw(12) << CalculateTax() << setw(12) << CalculateDiscount() << setw(12) << CalculatePayment() << endl;
}
...
int main()
{
    do
    {
        ...
        cout << "Please select one option of Menu : ";
        cin >> op;
        switch (op)
        {
        case 1:
